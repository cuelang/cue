...
type Encoder struct {
	cfg       *Config
	closer    io.Closer
	interpret func(*cue.Instance, *cue.Value) (*ast.File, error)
...
func (e *Encoder) Encode(inst *cue.Instance, v *cue.Value) error {
	if e.interpret != nil {
		f, err := e.interpret(inst, v)
		if err != nil {
			return err
		}
	...
	if v != nil {
		...
		return fmt.Errorf("unspported representation")
	}
	if e.encInst != nil {
		return e.encInst(inst)
	}
	if e.encValue != nil {
...
func (e *Encoder) encodeFile(f *ast.File, interpret func(*cue.Instance, *cue.Value) (*ast.File, error)) error {
