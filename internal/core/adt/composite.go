...
type Vertex struct {
	...
	// Ignore disables the closedness check for one level. This allows for
...
func (v *Vertex) AddStruct(info StructInfo) *StructInfo {
