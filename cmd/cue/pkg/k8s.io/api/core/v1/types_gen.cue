...
PersistentVolumeClaim: TypeMeta & {
	// Standard object's metadata.
	// More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
	// +optional
	metadata?: metav1.ObjectMeta @go(ObjectMeta) @protobuf(1,bytes,opt)
...
PersistentVolumeClaimList: TypeMeta & {
	// Standard list metadata.
	// More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
	// +optional
	metadata?: metav1.ListMeta @go(ListMeta) @protobuf(1,bytes,opt)
...
PersistentVolumeClaimResizing: "Resizing"

// PersistentVolumeClaimFileSystemResizePending - controller resize is finished and a file system resize is pending on node
PersistentVolumeClaimFileSystemResizePending: "FileSystemResizePending"
...
SecretVolumeSourceDefaultMode: 0o644
...
ConfigMapVolumeSourceDefaultMode: 0o644
...
ProjectedVolumeSourceDefaultMode: 0o644
...
ReplicationControllerReplicaFailure: "ReplicaFailure"
...
ReplicationController: TypeMeta & {
...
ReplicationControllerList: TypeMeta & {
	// Standard list metadata.
	// More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
	// +optional
	metadata?: metav1.ListMeta @go(ListMeta) @protobuf(1,bytes,opt)
...
DefaultClientIPServiceAffinitySeconds: 10800
...
PodPortForwardOptions: TypeMeta & {
...
LimitTypeContainer: "Container"

// Limit that applies to all persistent volume claims in a namespace
LimitTypePersistentVolumeClaim: "PersistentVolumeClaim"
...
ResourceQuotaScopeTerminating: "Terminating"

// Match all pod objects where !spec.activeDeadlineSeconds
ResourceQuotaScopeNotTerminating: "NotTerminating"

// Match all pod objects that have best effort quality of service
ResourceQuotaScopeBestEffort: "BestEffort"

// Match all pod objects that do not have best effort quality of service
ResourceQuotaScopeNotBestEffort: "NotBestEffort"

// Match all pod objects that have priority class mentioned
ResourceQuotaScopePriorityClass: "PriorityClass"
...
ScopeSelectorOpIn:           "In"
ScopeSelectorOpNotIn:        "NotIn"
ScopeSelectorOpExists:       "Exists"
ScopeSelectorOpDoesNotExist: "DoesNotExist"
...
DownwardAPIVolumeSourceDefaultMode: 0o644
