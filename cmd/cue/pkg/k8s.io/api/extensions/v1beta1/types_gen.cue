...
// Dummy definition
ReplicationControllerDummy: TypeMeta & {
}
...
RecreateDeploymentStrategyType: "Recreate"

// Replace the old RCs by new one using rolling update i.e gradually scale down the old RCs and scale up the new one.
RollingUpdateDeploymentStrategyType: "RollingUpdate"
...
RollingUpdateDaemonSetStrategyType: "RollingUpdate"

// Replace the old daemons only when it's killed
OnDeleteDaemonSetStrategyType: "OnDelete"
...
PodSecurityPolicyList: TypeMeta & {
	// Standard list metadata.
	// More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
	// +optional
	metadata?: metav1.ListMeta @go(ListMeta) @protobuf(1,bytes,opt)
