...
func TestBuiltins(t *testing.T) {
	...
	testCases := []struct {
		...
		test("list", `list.Avg([])`),
		`_|_(error in call to list.Avg: empty list provided)`,
	}, {
		...
		test("list", `list.Max([])`),
		`_|_(error in call to list.Max: empty list provided)`,
	}, {
		...
		test("list", `list.Min([])`),
		`_|_(error in call to list.Min: empty list provided)`,
	}, {
		...
		`_|_(error in call to list.Product: empty list provided)`,
	}, {
		...
		test("list", `list.Sum([])`),
		`_|_(error in call to list.Sum: empty list provided)`,
	}, {
