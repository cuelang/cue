...
func predeclared(n *ast.Ident) adt.Expr {
	...
	case "string", "__string":
		return &adt.BasicType{Src: n, Kind: adt.StringKind}
	case "bytes", "__bytes":
		return &adt.BasicType{Src: n, Kind: adt.BytesKind}
	case "bool", "__bool":
		return &adt.BasicType{Src: n, Kind: adt.BoolKind}
	case "int", "__int":
		return &adt.BasicType{Src: n, Kind: adt.IntKind}
	case "float", "__float":
		return &adt.BasicType{Src: n, Kind: adt.FloatKind}
	case "number", "__number":
		return &adt.BasicType{Src: n, Kind: adt.NumKind}
...
func newBound(op adt.Op, k adt.Kind, v adt.Expr) *adt.BoundExpr {
	return &adt.BoundExpr{Op: op, Value: v}
}
