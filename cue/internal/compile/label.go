...
type interpolationLabel ast.Interpolation

func (l *interpolationLabel) labelString() string { return "?" }

type dynamicLabelExpr struct{ ast.Label }

func (dynamicLabelExpr) labelString() string { return "{}" }

type bulkLabelExpr ast.ListLit

func (l *bulkLabelExpr) labelString() string { return "[?]" }

type ellipsisLabel ast.Ellipsis

func (l *ellipsisLabel) labelString() string { return "*" }

type embedLabel struct{}

func (embedLabel) labelString() string { return "{}" }

type forSource ast.ForClause

func (l *forSource) labelString() string {
...
type letCond ast.LetClause

func (l *letCond) labelString() string {
	// TODO: include more info in square brackets.
	return "let(cond)"
}
