...
func (x *listSentinel) Concreteness() Concreteness { return Concrete }
func (x *listSentinel) Source() ast.Node           { return nil }
func (x *listSentinel) Kind() Kind                 { return ListKind }
func (x *listSentinel) Specialize(k Kind) Value    { return x }
func (x *listSentinel) node()                      {}

type structSentinel struct{}

func (x *structSentinel) Concreteness() Concreteness { return Concrete }
func (x *structSentinel) Source() ast.Node           { return nil }
func (x *structSentinel) Kind() Kind                 { return StructKind }
func (x *structSentinel) Specialize(k Kind) Value    { return x }
func (x *structSentinel) node()                      {}
