...
func (x *Bottom) Source() ast.Node { return nil }
...
type BoundExpr struct {
	...
	// Kind  Kind // mostly used for number kind TODO: needed?
	Value Expr
}
...
type BuiltinValidator struct {
	...
	Args []Expr // any but the first value
...
type LetClause struct {
	Src   *ast.LetClause
	Scope *StructLit // additional fields made available within scope
	Dst   Yielder
}
