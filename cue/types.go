...
func newVertexRoot(idx *index, ctx *context, x *adt.Vertex) Value {
	if ctx != nil {
...
func newValueRoot(idx *index, ctx *context, x adt.Expr) Value {
...
func reference(rt *index, c *context, env *adt.Environment, r adt.Expr) (inst *Instance, path []string) {
	ctx := c
