...
// // FilterAttrs(include func(attr string) bool)
// // FilterAttrs indicates the attributes that should be included.
// //
// // Only applies to functions that generate output, such as Syntax and Export,
// // where the default is to include all attributes.
// func FilterAttrs(include ...string) Option {
// 	return func(p *options) { p.doAttrs = true }
// }
