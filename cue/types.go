...
func (v Value) Core(x *types.Value) {
	x.V = v.v
	x.R = v.idx
}
...
func newVertexRoot(idx *runtime.Runtime, ctx *context, x *adt.Vertex) Value {
	if ctx != nil {
...
func newValueRoot(idx *runtime.Runtime, ctx *context, x adt.Expr) Value {
...
func reference(rt *runtime.Runtime, c *context, env *adt.Environment, r adt.Expr) (inst *Instance, path []string) {
	ctx := c
