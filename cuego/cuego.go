...
// Complete sets previously undefined values in x that can be uniquely determined
...
//
// Complete does a JSON round trip. This means that data not preserved in such
